...
OPTIONS_SAT="SAT_HOME=/mnt/cmgis/zhangwenbo/code/image_text/code/CogVLM/basic_demo/model"
...
run_cmd="${OPTIONS_NCCL} ${OPTIONS_SAT} deepspeed --master_port 16666 --hostfile ${HOST_FILE_PATH} finetune_demo/finetune_demo.py ${gpt_options}"
echo ${run_cmd}
eval ${run_cmd}
